                    ...
                    <div class="row upper-footer-row">
                        <div class="col-md-4 footer-column text-center">
                            ...
                            <div class="foo-content text-center">
                                <a target="_blank" class="link-text"
                                    href="http://acl.gournadi.barisal.gov.bd/">acl.gournadi.barisal.gov.bd</a>
                            </div>
                        </div>
                        <div class="col-md-4 footer-column text-center">
                            <div class="fo-title">
                            ...
                            <div class="foo-content text-center">
                                <a class="social-icons facebook" target="_blank"
                                    href="http://www.facebook.com/minland.gov.bd"><i class="fa fa-facebook"></i></a>
                                <a class="social-icons youtube" target="_blank"
                                    href="https://www.youtube.com/channel/UCBlCPkpMK00tcPcdR-DTxrw"><i
                        ...
                        <div class="col-md-4 footer-column text-center">
                            <div class="fo-title">
                                <h2>কারিগরি সহায়তায়</h2>
                            </div>
                            <div class="foo-content text-center">
                                <a href="https://taqitizar.com/" target="_blank"><img class="img-fluid sponsor-img"
                                        src="{{ asset('images/taqi-logo.png') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
